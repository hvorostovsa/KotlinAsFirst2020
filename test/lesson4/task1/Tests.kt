...
class Tests {
    ...
    @Tag("2")
    fun mean() {
        assertEquals(0.0, mean(listOf(1.0, -1.0, 0.0)), 1e-5)
    ...
    fun factorize() {
        ...
        assertEquals(listOf(2, 3, 19, 31, 211), factorize(745674))
    ...
    @Tag("7")
    fun russian() {
        assertEquals("сто двенадцать тысяч", russian(112000))
        assertEquals("двести десять тысяч один", russian(210001))
